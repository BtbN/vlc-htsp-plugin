...
vlc_module_begin ()
    ...
    add_string( CFG_PREFIX"vextra", "", "Video Extra", "Transcode extra string for video transcoder", false )
    add_string( CFG_PREFIX"acodec", "", "Audio Codec", "Transcode target audio codec", false )
    add_string( CFG_PREFIX"aextra", "", "Audio Extra", "Transcode extra string for audio transcoder", false )
    add_string( CFG_PREFIX"scodec", "", "Subtitle Codec", "Transcode target subtitle codec", false )
    add_string( CFG_PREFIX"sextra", "", "Subtitle Extra", "Transcode extra string for subtitle transcoder", false )
